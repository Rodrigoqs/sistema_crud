        ...
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
               ...
               if(!isset($_POST["boton"]) && isset($_GET["cod"])){
                ?>
                <form action="modificacion.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="JznhPyOtIbT5qJP2++4Kf3yzt6sgaZmsMJqS0KZDJzBSi2bbVDOsanKePcpqiJs+6rCF5mWS98XUqefCkd9Xe988qYL6+aomNddlTf7nANQn9kRObdJQcZdSDDZR700b">
                    <div class="row">
...
if(isset($_POST["boton"])){
    ...
    $genero = $_POST["genero"];
    $modificacion = "UPDATE personal SET paterno='".$paterno."',materno='".$materno."',nombres='".$nombres."',genero='".$genero."' WHERE Id_personal=".$codigo.";";
    $ejecutar =  $conexion->query($modificacion);
}
 ?>
