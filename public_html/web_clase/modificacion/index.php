            ...
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
                    ...
                    <div class="mbr-section-btn align-center">
                        <?php
                        echo '<a class="btn btn-md btn-secondary display-4" href="modificacion.php?cod='.$rows[0].'&paterno='.$rows[1].'&materno='.$rows[2].'&nombres='.$rows[3].'&genero='.$rows[4].'"><span class="mbr-iconfont mbri-edit"></span>Modificar</a></div>';
                        ?>
                    </li>
