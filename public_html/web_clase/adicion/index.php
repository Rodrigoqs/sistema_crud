        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-secondary display-4" href="../index.html">
                        <span class="mbr-iconfont mbri-file"></span>Ir Menú Principal</a></div>
            </div>
        </div>
    </div>
                ...
                <form action="index.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="JznhPyOtIbT5qJP2++4Kf3yzt6sgaZmsMJqS0KZDJzBSi2bbVDOsanKePcpqiJs+6rCF5mWS98XUqefCkd9Xe988qYL6+aomNddlTf7nANQn9kRObdJQcZdSDDZR700b">
                    ...
                    <div class="dragArea row">
                        <div class="col-md-4  form-group" data-for="name">
                            ...
                            <input type="text" name="paterno" data-form-field="Name" class="form-control display-7" id="name-form1-2">
                        </div>
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-2" class="form-control-label mbr-fonts-style display-7">Materno</label>
                            <input type="text" name="materno" data-form-field="Email" class="form-control display-7" id="email-form1-2">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-2" class="form-control-label mbr-fonts-style display-7">Nombres</label>
                            <input type="text" name="nombres" data-form-field="Phone" class="form-control display-7" id="phone-form1-2">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-2" class="form-control-label mbr-fonts-style display-7">Genero</label>
                            <input type="text" name="genero" data-form-field="Phone" class="form-control display-7" id="phone-form1-2">
                        </div>
...
<?php
    if(isset($_POST["boton"])){
        ...
        $genero  = $_POST["genero"];
        $insercion = "INSERT INTO personal (paterno,materno,nombres,genero) VALUES ('$paterno','$materno','$nombres','$genero');";
        ...
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
                    ...
                    ?>
                    <br><li><strong>GENERO:</strong>
                    <?php
                    echo $rows[4];
                    ?>
                    <br>
                    <?php
                        echo "<img src='../codigo_qr/qr_img.php?d=".$rows[1]."'>";
                    ?>
                    </li>
                    <?php
                    endwhile;
