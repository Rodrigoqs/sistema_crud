    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">ELIMINACION DE REGISTROS</h1>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0" data-empty="No se encuetra">
            ...
            <td class="body-item mbr-fonts-style display-7">
                ...
                <?php
                    echo '<a class=" btn-md btn-secondary display-7" href="eliminacion.php?cod='.$rows[0].'&paterno='.$rows[1].'&materno='.$rows[2].'&nombres='.$rows[3].'&genero='.$rows[4].'&estado_civil='.$rows[5].'&carnet_de_identidad='.$rows[6].'&fecha_de_nacimiento='.$rows[7].'&telefono='.$rows[8].'&direccion_de_su_domicilio='.$rows[9].'&ocupacion='.$rows[10].'&correo_electronico='.$rows[11].'"><span class="mbr-iconfont mbri-trash"></span>Eliminar</a></div>';
                ?>
            </td>
            <td class="body-item mbr-fonts-style display-7">
